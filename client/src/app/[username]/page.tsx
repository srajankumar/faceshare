        ...
        <div className="flex flex-col justify-center items-center min-h-screen">
          ...
          <div className="max-w-xl flex flex-col justify-center items-center mx-8 mt-3">
            <p className="sm:max-w-md my-3 text-center">
              {userData.bio} Lorem ipsum dolor sit amet consectetur adipisicing
              elit. Optio doloribus blanditiis id itaque impedit facilis quae
              nobis inventore at nihil ipsa dicta ratione veniam magni, placeat
              eum eveniet possimus autem.
            </p>
